      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-genetic-competition-mixed-models-using-gencomp",
          title: 'Genetic competition mixed models using gencomp',
          description: "A short-course on mixed models applied to genetic competition analysis using the gencomp package",
          section: "Projects",handler: () => {
              window.location.href = "/projects/5_gencomp/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%61%75%6C%6F%63%68%61%76%65%73@%75%73%70.%62%72", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/saulo-chaves", "_blank");
        },
      },{
        id: 'social-lattes',
        title: 'Lattes',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/saulo-chaves-752374147", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0002-0694-1798", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=Rt_v_ooAAAAJ&hl", "_blank");
        },
      },{
      id: 'light-theme',
